<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Participants.aspx.cs" Inherits="NationalSymposium.ns.Admin.Participants" %>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h2 class="dashboard-title">Participants Details</h2>
        ...
        <asp:BoundField DataField="Name" HeaderText="Name" />
         ...
         <asp:BoundField DataField="Organization" HeaderText="Organization" />
            ...
            <div class="text-center">
                <asp:Button ID="Button1" runat="server" Text="Export Data" OnClick="Button1_Click" CssClass="common-btn  common-btn2" />
            </div>
        </div>
</div>
